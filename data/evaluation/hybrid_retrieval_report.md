...
| high_risk_context | 1 | 1.0 | 1.0 | 0.3333 | 0.3333 |
...
- `safety_001` hit=True strict=True rank=3 top=`canhgiacduoc`/`safety_article` ANSM: Các biện pháp giảm thiểu nguy cơ u màng não khi sử dụng dẫn chất progestin
