...
Để người đọc có thể đánh giá đồ án ngay trong báo cáo, bảng dưới đây tổng hợp trực tiếp các hạng mục đã hoàn thành và kết quả kiểm chứng tương ứng. Từ bảng này có thể thấy sản phẩm cuối của đồ án không phải một chatbot demo đơn giản, mà là một hệ thống có pipeline dữ liệu, pipeline truy xuất, pipeline an toàn, kết quả đo lường và cơ chế audit.
